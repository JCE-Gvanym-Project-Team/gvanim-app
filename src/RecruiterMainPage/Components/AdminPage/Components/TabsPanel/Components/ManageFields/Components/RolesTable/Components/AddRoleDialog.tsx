...
export default function AddRoleDialog(props: {roleName: any, setRoleName:any, roleStatus: any, setRoleStatus: any, handleAdd: any}) {
    const {
        roleName,
        setRoleName,
        roleStatus,
        ...
        <Box>
            ...
            >
                                    ...
                                    <Stack spacing={2.5} sx={{ width: '100%' }}>
                                        ...
                                        <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                            <FormControl fullWidth>
                                                <InputLabel id="demo-simple-select-label">סטטוס התפקיד</InputLabel>
                                                <Select
                                                    defaultValue={1}
                                                    size='small'
                                                    label="סטטוס התפקיד"
                ...
                <Stack spacing={1} direction='row' sx={{ padding: 2, display: 'flex', justifyContent: 'end' }}>
                    ...
                    <Button disabled={!roleName || roleStatus === null} onClick={handleAdd_} variant='contained' color='primary'>
                        הוסף
                    </Button>
